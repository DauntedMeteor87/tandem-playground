...
/* Debriefs — recap posts from trips your crews already took */
const DEBRIEFS = {
  yose:    { id:'yose', title:'Yosemite Weekend', crew:'Moonlight Crew', poster:'maya', when:'Last weekend', place:'Yosemite Valley', caption:'Sunrise over Half Dome — worth the 4am wake-up.' },
  pismo2:  { id:'pismo2', title:'Pismo Beach Cleanup', crew:'Surf Club', poster:'taylor', when:'2 weeks ago', place:'Pismo Beach', caption:'40 lbs of trash off the beach, then tacos.' },
  bishopd: { id:'bishopd', title:'Bishop Peak Sunset', crew:'Cal Poly Hiking', poster:'jordan', when:'3 weeks ago', place:'San Luis Obispo', caption:'Golden hour at the summit, whole crew made it up.' },
  sykesd:  { id:'sykesd', title:'Sykes Hot Springs', crew:'Field Studies', poster:'kai', when:'Last month', place:'Big Sur', caption:'Two-hour hike in was worth it for this view.' },
  skid:    { id:'skid', title:'Mammoth Ski Weekend', crew:'Ski & Snowboard', poster:'alex', when:'Last month', place:'Mammoth Lakes', caption:'Bluebird day on the mountain.' },
};
...
const S = {
  ...
  publishedTrip: null, // { clubId, tripId } — set right after the plan/activity flow publishes
};
...
function tripCard(t, variant){
  ...
  return `<button class="card tripcard ${cls}" data-nav="trip" data-param="${t.id}">
    ${phImg('', h)}
