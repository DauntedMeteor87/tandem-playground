...
const I = {
  ...
  airdrop:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 9.5a10.5 10.5 0 0115 0"/><path d="M7.5 12.5a6.5 6.5 0 019 0"/><path d="M10.4 15.6a2.6 2.6 0 013.2 0"/><path d="M12 17.6l-2.2 3.2h4.4L12 17.6z" fill="currentColor" stroke="none"/></svg>`,
  laptop: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="5" width="16" height="11" rx="1.5"/><path d="M2 20h20"/></svg>`,
};

/* ---------- Streak mascot — greyscale orangutan, evolves with weeks ---------- */
const ORANGUTAN = [
  // 0 weeks — sitting low, playing with rocks
  `<svg viewBox="0 0 100 100"><ellipse cx="50" cy="87" rx="30" ry="7" fill="#dcdce0"/>
    <path d="M28 82c-3-20 6-34 22-34s25 14 22 34c-1 6-9 9-22 9s-21-3-22-9z" fill="#3a3a3f"/>
    <path d="M34 66q-10 6-16 16" stroke="#3a3a3f" stroke-width="8" fill="none" stroke-linecap="round"/>
    <path d="M66 66q9 5 11 12" stroke="#3a3a3f" stroke-width="8" fill="none" stroke-linecap="round"/>
    <circle cx="36" cy="28" r="6.5" fill="#3a3a3f"/><circle cx="64" cy="28" r="6.5" fill="#3a3a3f"/>
    <circle cx="50" cy="40" r="18" fill="#3a3a3f"/>
    <ellipse cx="50" cy="44" rx="11" ry="9" fill="#eaeaec"/>
    <circle cx="45.5" cy="42" r="1.8" fill="#1c1c1e"/><circle cx="54.5" cy="42" r="1.8" fill="#1c1c1e"/>
    <path d="M45 48q5 4 10 0" stroke="#1c1c1e" stroke-width="1.6" fill="none" stroke-linecap="round"/>
    <circle cx="17" cy="83" r="5" fill="#a3a3a8"/><circle cx="26" cy="87" r="3.5" fill="#a3a3a8"/></svg>`,
  // 1 week — walking
  `<svg viewBox="0 0 100 100"><path d="M42 70q-7 13-11 21" stroke="#3a3a3f" stroke-width="9" fill="none" stroke-linecap="round"/>
    <path d="M58 70q8 9 6 23" stroke="#3a3a3f" stroke-width="9" fill="none" stroke-linecap="round"/>
    <path d="M38 50q-13 4-17 16" stroke="#3a3a3f" stroke-width="8" fill="none" stroke-linecap="round"/>
    <path d="M62 50q11 1 15-7" stroke="#3a3a3f" stroke-width="8" fill="none" stroke-linecap="round"/>
    <path d="M38 46c0-10 5-16 12-16s12 6 12 16v18c0 5-5 8-12 8s-12-3-12-8V46z" fill="#3a3a3f"/>
    <circle cx="38" cy="14" r="5.5" fill="#3a3a3f"/><circle cx="62" cy="14" r="5.5" fill="#3a3a3f"/>
    <circle cx="50" cy="24" r="16" fill="#3a3a3f"/>
    <ellipse cx="50" cy="27" rx="9.5" ry="7.5" fill="#eaeaec"/>
    <circle cx="46" cy="26" r="1.6" fill="#1c1c1e"/><circle cx="54" cy="26" r="1.6" fill="#1c1c1e"/>
    <path d="M46 31q4 3 8 0" stroke="#1c1c1e" stroke-width="1.4" fill="none" stroke-linecap="round"/>
    <path d="M10 58h9M8 66h8" stroke="#c4c4c8" stroke-width="2.5" fill="none" stroke-linecap="round"/></svg>`,
  // 2 weeks — jumping
  `<svg viewBox="0 0 100 100"><path d="M30 90q20 7 40 0" stroke="#c4c4c8" stroke-width="2.5" fill="none" stroke-linecap="round"/>
    <path d="M42 68q-5 10 1 17" stroke="#3a3a3f" stroke-width="9" fill="none" stroke-linecap="round"/>
    <path d="M58 68q5 10-1 17" stroke="#3a3a3f" stroke-width="9" fill="none" stroke-linecap="round"/>
    <path d="M37 46q-11-14-5-25" stroke="#3a3a3f" stroke-width="8" fill="none" stroke-linecap="round"/>
    <path d="M63 46q11-14 5-25" stroke="#3a3a3f" stroke-width="8" fill="none" stroke-linecap="round"/>
    <path d="M38 44c0-10 5-16 12-16s12 6 12 16v14c0 5-5 8-12 8s-12-3-12-8V44z" fill="#3a3a3f"/>
    <circle cx="38" cy="14" r="5.5" fill="#3a3a3f"/><circle cx="62" cy="14" r="5.5" fill="#3a3a3f"/>
    <circle cx="50" cy="23" r="16" fill="#3a3a3f"/>
    <ellipse cx="50" cy="26" rx="9.5" ry="7.5" fill="#eaeaec"/>
    <circle cx="46" cy="25" r="2.1" fill="#1c1c1e"/><circle cx="54" cy="25" r="2.1" fill="#1c1c1e"/>
    <circle cx="50" cy="30" r="2.2" fill="#1c1c1e"/></svg>`,
  // 3 weeks — sitting cross-legged, playing guitar, chill
  `<svg viewBox="0 0 100 100"><ellipse cx="50" cy="87" rx="30" ry="7" fill="#dcdce0"/>
    <path d="M26 82c-4-18 8-30 24-30s28 12 24 30c-2 6-46 6-48 0z" fill="#3a3a3f"/>
    <rect x="62" y="44" width="3.4" height="21" rx="1.5" fill="#a3a3a8"/>
    <ellipse cx="59" cy="68" rx="10" ry="13" fill="#a3a3a8"/>
    <circle cx="59" cy="66" r="3.2" fill="#3a3a3f"/>
    <path d="M40 68q9 3 13-4" stroke="#3a3a3f" stroke-width="7" fill="none" stroke-linecap="round"/>
    <path d="M67 70q6-3 7-11" stroke="#3a3a3f" stroke-width="7" fill="none" stroke-linecap="round"/>
    <circle cx="36" cy="28" r="6.5" fill="#3a3a3f"/><circle cx="64" cy="28" r="6.5" fill="#3a3a3f"/>
    <circle cx="50" cy="40" r="18" fill="#3a3a3f"/>
    <ellipse cx="50" cy="44" rx="11" ry="9" fill="#eaeaec"/>
    <path d="M44 41q2-2.4 4 0" stroke="#1c1c1e" stroke-width="1.6" fill="none" stroke-linecap="round"/>
    <path d="M52 41q2-2.4 4 0" stroke="#1c1c1e" stroke-width="1.6" fill="none" stroke-linecap="round"/>
    <path d="M44 48q6 5 12 0" stroke="#1c1c1e" stroke-width="1.6" fill="none" stroke-linecap="round"/></svg>`,
];
function orangutan(weeks, size=56){
  const stage = ORANGUTAN[Math.max(0, Math.min(ORANGUTAN.length-1, weeks|0))];
  return `<div class="mascot" style="width:${size}px;height:${size}px;flex:none">${stage}</div>`;
}

/* ---------- Past trips (completed adventures — feed the patch key + My Trips) ---------- */
const PAST_TRIPS = [
...
/* Archives — inspiration board of trips people already took (Pinterest-style).
   kind drives the Activities/Adventures filter; roster = who was there (for the detail view). */
const ARCHIVES = {
...
/* alias kept so any 0.3 reference still resolves */
const DEBRIEFS = ARCHIVES;
/* Club bulletin — articles + outreach from clubs you're part of */
const CLUB_BULLETIN = {
  b1: { id:'b1', club:'Field Studies', type:'Article', title:'Trip report: Sykes was unreal', blurb:"Read how Saturday's overnight went.", when:'2 days ago' },
  b2: { id:'b2', club:'Surf Club', type:'Recruiting', title:'Join our team — no experience needed', blurb:'We teach beginners every Friday dawn patrol.', when:'4 days ago' },
  b3: { id:'b3', club:'Cal Poly Hiking', type:'Article', title:'Gear check: what to pack for spring hikes', blurb:'Layers, water, and a headlamp — the full list.', when:'5 days ago' },
  b4: { id:'b4', club:'Climbing Club', type:'Recruiting', title:'New member social this Thursday', blurb:'Free pizza, free rentals, come say hi.', when:'1 week ago' },
  b5: { id:'b5', club:'Ski & Snowboard', type:'Article', title:'Mammoth trip recap + photos', blurb:'22 of us made it up for the weekend.', when:'1 week ago' },
};
/* Friends bulletin — ordinary posts from people you follow */
const FRIENDS_BULLETIN = {
  f1: { id:'f1', person:'maya', title:'Found the best trailhead coffee', blurb:'Stopping here before every hike now.', when:'1 day ago' },
  f2: { id:'f2', person:'kai', title:'First time camping solo!', blurb:'Nervous but it went great, ask me anything.', when:'2 days ago' },
  f3: { id:'f3', person:'riley', title:'New PR on the Bishop Peak trail run', blurb:'32 minutes up, legs are gone.', when:'3 days ago' },
  f4: { id:'f4', person:'taylor', title:'Board repair worked!', blurb:'Ding is fixed, back in the water this weekend.', when:'4 days ago' },
  f5: { id:'f5', person:'jordan', title:'Developed film from the Sykes trip', blurb:'Old camera, new memories.', when:'5 days ago' },
};
...
const S = {
  ...
  hubCell: 'c',
  ob: { name:'', year:'', major:'', from:'', activities:[], bio:'', pfp:false, mainPhoto:false, extras:0, prompt:'', promptText:'' },
  publishedTrip: null, // { crewId, tripId, kind } — set right after the plan/activity flow publishes
  tripResponse: null,  // null | 'yes' | 'no' — how you answered the trip that pops up in the crew chat
};
...
function cardSize(variant){ return variant==='grid' ? ['tripcard--grid',120] : (variant ? ['tripcard--sm',104] : ['',150]); }
function tripCard(t, variant){
  const [cls,h] = cardSize(variant);
  // Activities link straight to their own screen (date + chat); Adventures open the full trip page.
  const dest = t.kind==='Activity' ? 'activity' : 'trip';
  return `<button class="card tripcard ${cls}" data-nav="${dest}" data-param="${t.id}">
    ${phImg('', h)}
...
/* Generic shelf card — same tripcard look, used by debriefs + bulletins */
function shelfCard({title, sub, tag, meta, nav, param}, variant){
  const [cls,h] = cardSize(variant);
  return `<button class="card tripcard ${cls}" data-nav="${nav}" ${param?`data-param="${param}"`:''}>
    ${phImg('', h)}
    <div class="tripcard__meta">
      <div class="tripcard__title">${title}</div>
      <div class="tripcard__row">${sub}</div>
      <div class="tripcard__row" style="margin-top:8px;justify-content:space-between">
...
const ACTIONS = {};
const WIDE_SCREENS = new Set(['create-desktop']);
